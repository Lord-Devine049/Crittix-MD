...
module.exports = [
  {
    ...
    execute: async ({ text, reply }) => {
      if (!text) return reply('📝 *Usage:* spellcheck your text here');
      try {
  ...
  },
  {
    ...
    execute: async ({ text, reply }) => {
      if (!text) return reply('📄 *Usage:* summarize your long text here');
      try {
        const result = await ask(
  ...
  },
  {
    ...
    execute: async ({ text, reply }) => {
      if (!text) return reply('✏️ *Usage:* paraphrase your text here');
      try {
        const result = await ask(
  ...
  },
  {
    ...
    execute: async ({ text, reply }) => {
      if (!text) return reply('🔍 *Usage:* explain black holes');
      try {
        const result = await ask(
  ...
  },
  {
    ...
    execute: async ({ text, reply }) => {
      if (!text) return reply('🔑 *Usage:* keywords your text here');
      try {
        const result = await ask(
  ...
  },
  {
    ...
    execute: async ({ text, reply }) => {
      if (!text) return reply('😊 *Usage:* sentiment I love this so much!');
      try {
        const result = await ask(
  ...
  },
  {
    ...
    execute: async ({ text, reply }) => {
      if (!text) return reply('✍️ *Usage:* titlegen blog post about healthy eating');
      try {
        const result = await ask(
  ...
  },
  {
    ...
    execute: async ({ text, reply }) => {
      if (!text) return reply('📸 *Usage:* captiongen my gym workout photo');
      try {
        const result = await ask(
  ...
  },
  {
    ...
    execute: async ({ text, reply }) => {
      if (!text) return reply('#️⃣ *Usage:* hashtaggen travel photography');
      try {
        const result = await ask(
  ...
  },
  {
    ...
    execute: async ({ text, reply }) => {
      if (!text) return reply('📧 *Usage:* emailgen request a day off from work');
      try {
        const result = await ask(
  ...
  },
  {
    ...
    execute: async ({ text, reply }) => {
      if (!text) return reply('🏷️ *Usage:* nameai cool gaming clan names');
      try {
        const result = await ask(
  ...
  },
  {
    ...
    execute: async ({ text, reply }) => {
      if (!text) return reply('⚖️ *Usage:* debateai should school be year-round');
      try {
        const result = await ask(
  ...
  },
  {
    ...
    execute: async ({ args, text, reply }) => {
      ...
      if (!character) return reply('🎭 *Usage:* characterai Yoda\n\nThen ask them anything!');
      try {
        const result = await ask(
  ...
  },
  {
    ...
    execute: async ({ text, reply }) => {
      if (!text) return reply('🍳 *Usage:* recipegen eggs cheese onion');
      try {
        const result = await ask(
