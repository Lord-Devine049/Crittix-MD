...
module.exports = {
  ...
  description: 'Toggle antispam — on / off / set kick / set delete',
  sudoOnly:    true,
  groupOnly:   true,
  ...
  execute: async ({ sock, args, chatId, reply }) => {
    ...
    const infoText = () => {
      const cur = db.getAnti(chatId, 'antispam') || 'off';
      return `ℹ️ antispam: *${cur}*\n\n.antispam on — warn 3x then kick\n.antispam set kick — delete + instant kick\n.antispam set delete — delete + mention only\n.antispam off — disable`;
    };
